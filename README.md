# com-chilipeppr-workspace-church1
A ChiliPeppr Workspace church1.

![alt text](screenshot.png "Screenshot")

## ChiliPeppr Workspace / church1
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-workspace-church1 |
| Name                  | Workspace / church1 |
| Description           | A ChiliPeppr Workspace church1. |
| chilipeppr.load() URL | http://raw.githubusercontent.com/BisonHill/workspace-church1/master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/bisonhillstonecrafts/workspace-church1 |
| Github URL            | http://github.com/BisonHill/workspace-church1 |
| Test URL              | https://preview.c9users.io/bisonhillstonecrafts/workspace-church1/workspace.html |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/BisonHill/workspace-church1/master/auto-generated-workspace.html",
  function() {
    // Callback after workspace loaded into #pnlWorkspace
    // Now use require.js to get reference to instantiated workspace
    cprequire(
      ["inline:com-chilipeppr-workspace-church1"], // the id you gave your workspace
      function(myWorkspaceChurch1) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Workspace / church1 just got loaded.", myWorkspaceChurch1);
        myWorkspaceChurch1.init();
      }
    );
  }
);
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-workspace-church1"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Workspace / church1"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"A ChiliPeppr Workspace church1."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/BisonHill/workspace-church1/master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/bisonhillstonecrafts/workspace-church1"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/BisonHill/workspace-church1"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://workspace-church1-bisonhillstonecrafts.c9users.io/workspace.html"</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
...
follows the standard template for workspace pulldown menus.</td></tr><tr valign="top"><td>setupResize</td><td>function</td><td>function () <br><br>Listen to window resize event.</td></tr><tr valign="top"><td>onResize</td><td>function</td><td>function () <br><br>When browser window resizes, forcibly resize the Console window</td></tr><tr valign="top"><td>loadLuaEditorWidget</td><td>function</td><td>function (callback) <br><br>Load the Lua Editor widget via chilipeppr.load()
widget they can fork as a starting point for their own.</td></tr><tr valign="top"><td>loadTemplateWidget</td><td>function</td><td>function (callback) <br><br>Load the Template widget via chilipeppr.load() so folks have a church1
